...
namespace Odin.Activation
{
        ...
        where T : class
    {
        ...
        // You can override this method to add extra validation on activation args to determine if
        // your ActivationHandler should handle this activation args
