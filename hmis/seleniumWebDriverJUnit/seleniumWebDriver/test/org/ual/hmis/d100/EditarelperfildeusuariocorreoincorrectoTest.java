...
public class EditarelperfildeusuariocorreoincorrectoTest {
	...
	@Test
	public void editarelperfildeusuariocorreoincorrecto() {
		...
		driver.findElement(By.id("Input_NewEmail")).sendKeys("nomail");
		{
		...
		assertThat(driver.findElement(By.id("Input_NewEmail-error")).getText(),
				is("The New email field is not a valid e-mail address."));
