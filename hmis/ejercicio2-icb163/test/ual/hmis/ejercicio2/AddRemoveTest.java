...
public class AddRemoveTest {
	...
	public void addRemove() {
		...
		driver.manage().window().setSize(new Dimension(908, 836));
		...
		driver.findElement(By.cssSelector(".item:nth-child(2) .name")).click();
		driver.findElement(By.cssSelector(".item:nth-child(2) .name")).click();
		assertThat(driver.findElement(By.cssSelector(".item:nth-child(2) .name")).getText(), is("uno"));
		driver.findElement(By.cssSelector(".form-control")).click();
		...
		{
			List<WebElement> elements = driver.findElements(By.cssSelector(".item:nth-child(3) .name"));
			assert (elements.size() > 0);
		}
		driver.findElement(By.cssSelector(".form-control")).click();
		driver.findElement(By.cssSelector(".form-control")).sendKeys("tres");
		driver.findElement(By.cssSelector(".btn-success")).click();
		assertThat(driver.findElement(By.cssSelector(".item:nth-child(4) .name")).getText(), is("tres"));
		{
			WebElement element = driver.findElement(By.cssSelector(".btn-success"));
			Actions builder = new Actions(driver);
			builder.moveToElement(element).perform();
