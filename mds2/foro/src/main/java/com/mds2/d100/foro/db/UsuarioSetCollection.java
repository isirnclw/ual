...
public class UsuarioSetCollection extends org.orm.util.ORMSet {
	public UsuarioSetCollection(Object owner, org.orm.util.ORMAdapter adapter, int ownerKey, int targetKey,
			int collType) {
	 ...
	 *                     <li>contrasena</li>
	 *                     <li>email</li>
	 *                     <li>perfil_publico</li>
	 *                     <li>conectado</li>
	 *                     <li>notificarAlCorreo</li>
	 *                     <li>notificarRespuestas</li>
	 *                     <li>maxItemsPerfil</li>
	 *                     <li>importancia</li>
	 *                     <li>reportado</li>
	 *                     </ul>
